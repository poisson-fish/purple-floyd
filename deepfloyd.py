...
HF_TOKEN = os.getenv('TOKEN')  # HuggingFace Token
login(HF_TOKEN, True)
...
while (True):
    ...
    text_encoder.device_map = infer_auto_device_map(
        text_encoder, max_memory={0: "8GiB", "cpu": "30GiB"})

    print("finish!")

    # load stage1 model for text encoding
